...
The command below will perform the random forest algorithm. The parameters are similar to those used to construct the model in the class about linear regression. The parameter **x** contains the matrix of predictors and the parameter **y** contains the response variable.
